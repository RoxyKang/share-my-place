...
const Auth = () => {
  ...
  // React: if we have multiple state changes in the same sync code block,
  //        it will batch them together and perform one single state update and one single re-render
